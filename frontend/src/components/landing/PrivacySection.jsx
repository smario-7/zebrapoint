    ...
    <section className="py-24 bg-slate-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          <p className="text-zebra-400 font-semibold text-sm uppercase tracking-widest mb-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {POINTS.map((point, i) => (
            <div
              key={i}
              className="bg-slate-700/50 border border-slate-600 rounded-2xl p-6 flex gap-4 items-start hover:bg-slate-700 transition"
            >
