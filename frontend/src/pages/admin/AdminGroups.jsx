...
export default function AdminGroups() {
  ...
  useEffect(() => {
    api
      ...
      .catch(() => toast.error("Nie udało się pobrać grup"))
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-slate-800 mb-6">🦓 Grupy</h1>
      <div className="bg-white rounded-2xl border overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b">
            <tr>
              {["Nazwa", "Uczestnicy", "Kategoria", "Słowa kluczowe"].map((h) => (
                <th
                  key={h}
